...
int main() {
    ...
    ASSERT(8, ({ int x; x=3; int y; y=5; x+y; }));
    ...
    ASSERT(0, ({ int x[2][3]; int *y; y=x; *y=0; **x; }));
    ASSERT(1, ({ int x[2][3]; int *y; y=x; *(y+1)=1; *(*x+1); }));
    ASSERT(2, ({ int x[2][3]; int *y; y=x; *(y+2)=2; *(*x+2); }));
    ASSERT(3, ({ int x[2][3]; int *y; y=x; *(y+3)=3; **(x+1); }));
    ASSERT(4, ({ int x[2][3]; int *y; y=x; *(y+4)=4; *(*(x+1)+1); }));
    ASSERT(5, ({ int x[2][3]; int *y; y=x; *(y+5)=5; *(*(x+1)+2); }));
    ...
    ASSERT(0, ({ int x[2][3]; int *y; y=x; y[0]=0; x[0][0]; }));
    ASSERT(1, ({ int x[2][3]; int *y; y=x; y[1]=1; x[0][1]; }));
    ASSERT(2, ({ int x[2][3]; int *y; y=x; y[2]=2; x[0][2]; }));
    ASSERT(3, ({ int x[2][3]; int *y; y=x; y[3]=3; x[1][0]; }));
    ASSERT(4, ({ int x[2][3]; int *y; y=x; y[4]=4; x[1][1]; }));
    ASSERT(5, ({ int x[2][3]; int *y; y=x; y[5]=5; x[1][2]; }));
